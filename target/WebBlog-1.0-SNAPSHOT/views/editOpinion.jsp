...
<h1 class="text-center text-info">Edit your opinion</h1>
<form action="/article/editopinion/${opinion.id}" method="post" class="col-sm-6">
    <div class="form-group ">
    <label for="textOpinion"></label><textarea class="form-control" name="textOpinion" id="textOpinion"  rows="4">${opinion.text}</textarea>
    </div>
    <div class="form-group ">
    <label for="mark">Mark:</label>
    <input class="form-control" value="${opinion.mark}"  name="mark" id="mark" type="number">
    </div>
    <div class="form-group ">
    <label for="date">Date:</label>
    <input class="form-control" value="${opinion.date}" name="date" id="date" type="date">
    </div>
