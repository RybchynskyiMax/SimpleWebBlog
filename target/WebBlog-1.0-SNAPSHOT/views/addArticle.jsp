...
<h1>Add article!</h1>
<form action="/addarticle" method="post" class="col-sm-6">
    <div class="form-group ">
    <label for="subject">Subject:</label>
    <input class="form-control" name="subject" id="subject" type="text">
    </div>
    <div class="form-group">
    <label for="textArticle"></label><textarea class="form-control" name="textArticle" id="textArticle"  rows="4"></textarea>
    </div>
