...
<h1 class="text-center text-info">Edit your review</h1>
<form action="/article/editopinion/${review.id}" method="post" class="col-sm-6">
    <div class="form-group ">
    <label for="textOpinion"></label><textarea class="form-control" name="textOpinion" id="textOpinion"  rows="4">${review.text}</textarea>
    </div>
    <div class="form-group ">
    <label for="mark">Mark:</label>
    <input class="form-control" value="${review.mark}"  name="mark" id="mark" type="number">
    </div>
    <div class="form-group ">
    <label for="date">Date:</label>
    <input class="form-control" value="${review.date}" name="date" id="date" type="date">
    </div>
