...
<nav class="navbar navbar-inverse">
    ...
    <p class="buity_text">GLOR TV</p>
        <p class="buity_text">Blog where you can find everything about sport!</p>
</div>

<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
<script src="/resources/js/bootstrap.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/resources/js/jquery.tubular.1.0.js"></script> <!-- подключаем плагин -->
<script type="text/javascript" charset="utf-8" src="/resources/js/index.js"></script> <!-- добавляем id видеофайла с Youtube -->
